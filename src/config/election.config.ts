...
export const INTERVAL_DNA_PREVIOUS_VOTE_END = (process.env.INTERVAL_DNA_PREVIOUS_VOTE_END) ? parseInt(process.env.INTERVAL_DNA_PREVIOUS_VOTE_END) : 3290000
export const CURRENT_PERIOD_REVOTE_START = (process.env.CURRENT_PERIOD_REVOTE_START) ? parseInt(process.env.CURRENT_PERIOD_REVOTE_START) : 3200000
...
export const ELECTION_PERIODS_UNLOCK = [3216000, 3287513, 3352525, 3412525, 3472525, 3522525, 3582525]
export const ELECTION_PERIODS = [
    { start: 3085800, end: 3143806, revoteStart: 0, revoteEnd: 0 },
    { start: 3178006, end: 3227234, revoteStart: 3216000, revoteEnd: 3220000 },
