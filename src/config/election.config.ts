...
export const ELECTION_PERIODS_UNLOCK = (process.env.ELECTION_PERIODS_UNLOCK) ? parseInt(process.env.ELECTION_PERIODS_UNLOCK) : [3216000, 3287513, 3352525, 3412525, 3472525, 3522525, 3582525]
