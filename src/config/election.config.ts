...
export const SECONDARY_ELECTION_START = (process.env.SECONDARY_ELECTION_START) ? parseInt(process.env.SECONDARY_ELECTION_START) : 3500000
export const SECONDARY_ELECTION_END = (process.env.SECONDARY_ELECTION_END) ? parseInt(process.env.SECONDARY_ELECTION_END) : 3600000
...
export const SECONDARY_VOTE_UNLOCK = (process.env.SECONDARY_VOTE_UNLOCK) ? parseInt(process.env.SECONDARY_VOTE_UNLOCK) : 3610000
